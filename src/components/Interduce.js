      ...
      <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex items-center justify-center flex-col my-10 lg:gap-10">
        ...
        <div className="flex items-center m-auto justify-center w-11/12 lg:w-3/4 lg:mr-10">
          <span className="flex flex-col gap-3 text-white items-start  text-base justify-center font-semibold lg:text-lg">
            <p>
              I'm Arafath, a Full-stack Web Developer from Visakhapatnam with
              expertise in React,Node.js, and Express.js. With over 1 year of
              experience, I've built high-performing web applications, including
              chat-application and CampGround Website . As a Tech Lead & Web
              Developer With a passion for learning and attention to detail, I'm
              committed to delivering impactful digital experiences. Let's
