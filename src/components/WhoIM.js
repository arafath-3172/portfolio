        ...
        <div className="flex items-center m-auto justify-center w-11/12 lg:w-4/5">
          <span className="flex flex-col gap-3 text-white items-start  text-base justify-center font-thin lg:text-lg">
            <p className="text-start mt-3 mx-auto md:mx-0">
              I'm Arafath, a passionate Full-stack Web Developer based in
              Visakhapatnam , India. With 1+ years of experience, I specialize
              in the MERN stack, including React, Node.js, and Express.js. I've
              crafted high-performing web applications showcasing my skills
              through projects like a Chat Application and Campground Review
              Site. As a Tech Lead & Web Developer With a focus on continuous
              learning and attention to detail, I'm dedicated to delivering
              cutting-edge solutions. Let's connect and create something amazing
              together!
            </p>
            ...
            <div className="flex items-center justify-center gap-3 font-sans text-gray-200">
              <FaHandPointRight /> Web Development
              <FaHandPointRight /> Competetive Programming
            </div>
          </span>
        </div>
      </div>
